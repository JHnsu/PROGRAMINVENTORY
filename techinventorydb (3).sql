...
INSERT INTO `inventory` (`ItemID`, `ItemName`, `Category`, `Brand`, `StockLevel`, `MinimumStockLevel`, `UnitPrice`, `StockStatus`, `ItemImage`, `CreatedAt`, `UpdatedAt`) VALUES
...
INSERT INTO `purchaseorders` (`PurchaseOrderID`, `CreatedBy`, `ItemID`, `ItemName`, `Brand`, `Quantity`, `Receiver`, `TotalPrice`, `PurchaseDate`, `Status`) VALUES
(1, 1, 1, 'Laptop Pro', 'BrandA', 10, 'Admin User', 12000.00, '2024-12-06 03:10:31', 'Completed'),
(2, 2, 2, 'Desktop Basic', 'BrandB', 5, 'John Doe', 4000.00, '2024-12-06 03:10:31', 'Completed'),
(3, NULL, NULL, 'lap', 'das', 2, 'sas', NULL, '2024-12-06 13:38:19', 'Completed'),
(4, NULL, NULL, 'asdasdsa', 'asdasdas', 1, 'sdasdas', NULL, '2024-12-07 13:38:19', 'Pending');
...
(42, 'shaine', 'Login', '2024-12-12 09:36:26', NULL);
